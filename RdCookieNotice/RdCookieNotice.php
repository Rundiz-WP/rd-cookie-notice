...
class RdCookieNotice
{
    ...
    public static function instance()
    {
        if (null === self::$classInstance) {
            ...
            add_action('init', [self::$classInstance, 'loadTextdomain']);

            self::$classInstance->includes();
        }
    ...
    public function loadDefaults()
    {
        ...
        if (true === $this->options['general']['translate']) {
    ...
    public static function cookies_accepted() 
    {
        return apply_filters(
            ...
            (isset($_COOKIE['cookie_notice_accepted']) && strtolower(sanitize_text_field(wp_unslash($_COOKIE['cookie_notice_accepted']))) === 'true')
        );
    }// cookies_accepted
